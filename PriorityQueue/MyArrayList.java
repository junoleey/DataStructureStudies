public class MyArrayList<Type extends Comparable<Type>> {
    ...
    private int capacity = 16; //length of the array list and the current max size
    private Type[] list = (Type[]) new Comparable[capacity]; //store the elements of the list in this array
    ...
    public void insert(Type item, int index) {
        if (size == 0) {
            ...
            Type[] copyList = (Type[]) new Comparable[capacity];
            int copyIndex = 0;
